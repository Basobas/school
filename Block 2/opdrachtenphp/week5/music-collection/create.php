...
if (isset($_REQUEST['submit'])) {
    ...
    $artist = mysqli_real_escape_string($db, $_REQUEST['artist']);
    $name = mysqli_escape_string($db, $_REQUEST['name']);
    $genre = mysqli_escape_string($db, $_REQUEST['genre']);
    $year = mysqli_escape_string($db, $_REQUEST['year']);
    $tracks = mysqli_escape_string($db, $_REQUEST['tracks']);
